...
# Chemin de la vidéo
video_path = "img/video/alley_-_39837 (1080p).mp4"
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose, \
    ...
    while cap.isOpened():
        ...
        # Vérifier si la lecture de la vidéo a réussi
        if not ret:
            break

        # Faire la détection de poses et de visages avec Mediapipe
        ...
        while cap.isOpened():
            ...
            try:
                if pose_results.pose_landmarks is not None:
                    ...
                    wrist_movement_intensity = abs(left_wrist_y - prev_left_wrist_y) + abs(
                        right_wrist_y - prev_right_wrist_y)
                    ...
                    cv2.putText(image, wrist_intensity_text, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
                                cv2.LINE_AA)
                    cv2.putText(image, leg_intensity_text, (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
                                cv2.LINE_AA)
                    cv2.putText(image, arm_intensity_text, (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
                                cv2.LINE_AA)
                    cv2.putText(image, head_intensity_text, (50, 200), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
                                cv2.LINE_AA)
                    ...
                    cv2.putText(image, dancing_text, (50, 250), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
                                cv2.LINE_AA)
                ...
                cv2.putText(image, f"Number of Faces: {num_faces}", (200, 300), cv2.FONT_HERSHEY_SIMPLEX, 1,
